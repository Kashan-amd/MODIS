...
<body class="bg-white dark:bg-zinc-800">
    ...
    <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group expandable :heading="__('Reports')" class="hidden lg:grid" :expanded="true">
                <flux:navlist.item icon="document-chart-bar" :href="route('financial-reports')" wire:navigate>
