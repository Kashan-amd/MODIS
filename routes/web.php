...
Route::middleware(["auth"])->group(function () {
    ...
    Route::get("accounts/transactions/print-ledger", [\App\Http\Controllers\TransactionsPdfController::class, "printLedger"])->name(
        "accounts.transactions.print-ledger",
    );
    ...
    Volt::route("accounts/financial-reports", "accounting.financial-reports")->name("financial-reports");
