    ...
    public function run(): void
    {
        ...
        if (!$organization)
        {
            $organization = Organization::create([
                ...
                'postal_code' => '12345',
                'phone' => '+923001234567',
                'email' => 'info@osccorporation.com',
            ]);
        }

        // Standard Chart of Accounts for a service business
        $this->createAssetAccounts($organization->id);
        $this->createLiabilityAccounts($organization->id);
        $this->createEquityAccounts($organization->id);
        $this->createIncomeAccounts($organization->id);
        $this->createExpenseAccounts($organization->id);
    }

    protected function createAssetAccounts($organizationId)
    {
        ...
        $this->createAccounts($assetAccounts, 'asset', $organizationId);
    }

    protected function createLiabilityAccounts($organizationId)
    {
        ...
        $this->createAccounts($liabilityAccounts, 'liability', $organizationId);
    }

    protected function createEquityAccounts($organizationId)
    {
        ...
        $this->createAccounts($equityAccounts, 'equity', $organizationId);
    }

    protected function createIncomeAccounts($organizationId)
    {
        ...
        $this->createAccounts($incomeAccounts, 'income', $organizationId);
    }

    protected function createExpenseAccounts($organizationId)
    {
        ...
        $this->createAccounts($expenseAccounts, 'expense', $organizationId);
    }

    protected function createAccounts($accounts, $type, $organizationId)
    {
