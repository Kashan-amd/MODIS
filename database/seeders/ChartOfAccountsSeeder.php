...
class ChartOfAccountsSeeder extends Seeder
{
    ...
    protected function createContraAccounts()
    {
        // Contra accounts (75-79)
        $contraAccounts = [
            ["account_number" => "75", "name" => "Rate Adjustment", "description" => "Rate adjustments on sales"],
            ["account_number" => "76", "name" => "Sales Discounts", "description" => "Discounts given on sales"],
        ];

        $this->createAccounts($contraAccounts, "contra");
    }
